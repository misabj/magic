...
export default function FillerSpotlight() {
    ...
    const T = {
        sr: {
            ...
            fillers: [
                { name: "Vitaminska Bomba", desc: "Hijaluron 2% + elastin + alge" },
                { name: "Anti-Age", desc: "Hijaluron 5% — popunjava bore" },
                { name: "Duboka Hidratacija", desc: "Kolagen + vitamin C + zob" },
                { name: "Za Akne", desc: "Dud + kantarion + lecitin" },
                { name: "Eye Rescue", desc: "Izbeljivanje podočnjaka" },
                { name: "Skin Relief", desc: "Neven + vučji trn — reaktivna koža" },
            ],
        },
        en: {
            ...
            fillers: [
                { name: "Vitamin Bomb", desc: "Hyaluronic 2% + elastin + algae" },
                { name: "Anti-Age", desc: "Hyaluronic 5% — fills wrinkles" },
                { name: "Deep Hydration", desc: "Collagen + vitamin C + oat" },
                { name: "For Acne", desc: "Mulberry + St. John's wort + lecithin" },
                { name: "Eye Rescue", desc: "Under-eye brightening" },
                { name: "Skin Relief", desc: "Calendula + Sea buckthorn — reactive skin" },
            ],
        },
    }[lang];
